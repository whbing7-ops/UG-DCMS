...
checks = {
    ...
    'versioned runtime name': 'venv-1.0.0-rc2.29-' in ps,
    'versioned release name': 'app-1.0.0-rc2.29-' in ps,
    ...
    'frontend upgrade invalidates cache': 'FreshStaticFiles' in main_api
        and 'no-store, max-age=0' in main_api and '?v=rc2.29' in index_html,
