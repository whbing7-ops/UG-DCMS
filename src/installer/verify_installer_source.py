...
checks = {
    ...
    'CMD output version': 'rc2.41.exe' in (ROOT/'installer'/'BUILD-SETUP.cmd').read_text(),
    ...
    'versioned runtime name': 'venv-1.0.0-rc2.41-' in ps,
    'versioned release name': 'app-1.0.0-rc2.41-' in ps,
    ...
    'frontend upgrade invalidates cache': 'FreshStaticFiles' in main_api
        and 'no-store, max-age=0' in main_api and '?v=rc2.41' in index_html,
