...
$releaseName = 'app-1.0.0-rc2.39-' + (Get-Date -Format 'yyyyMMddHHmmss')
...
$runtimeName = 'venv-1.0.0-rc2.39-' + (Get-Date -Format 'yyyyMMddHHmmss')
...
if([int]$migrationCount -ne 22){ Fail "数据库迁移数量异常：期望 22，实际 $migrationCount" }
