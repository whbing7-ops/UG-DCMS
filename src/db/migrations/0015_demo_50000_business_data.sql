...
UPDATE design_baseline b SET is_current=true
WHERE b.baseline_code LIKE 'BL-DEMO50K-%' AND b.status='RELEASED';

UPDATE part_number pn SET current_baseline_id=b.id
FROM design_baseline b
